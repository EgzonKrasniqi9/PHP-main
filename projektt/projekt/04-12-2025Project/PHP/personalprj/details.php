  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Book your car</h1>
        <p class="lead text-muted">You can book your car by clicking the button below</p>
      </div>
    </div>
  </section>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-6">
                  <?php if ($id == 1): ?>
                    <img src="a.jpg" alt="Car Image" class="img-fluid">
                  <?php elseif ($id == 3): ?>
                    <img src="k.jpg" alt="Car Image" class="img-fluid">
                  <?php else: ?>
                    <img src="g.jpg" alt="Car Image" class="img-fluid">
                  <?php endif; ?>
                  <img src="4.jpg" alt="Car Image" class="img-fluid" style="max-width: 200px; max-height: 150px;">
                </div>
                <div class="col-lg-7 col-md-7 col-sm-6">
                    <h4 class="box-title mt-5"><?php echo $movie_data['Name']; ?></h4>
                    <p><?php echo $movie_data['Gear']; ?></p>
                    <form action="book.php" method="post" enctype="multipart/form-data">
                    <div class="form-floating">
                      <input type="number" class="form-control" id="floatingInput" placeholder="Number of Days" name="nr_Days" >
