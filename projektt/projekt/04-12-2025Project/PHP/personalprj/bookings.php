...
if (!isset($_SESSION['is_admin'])) {
    die("Error: User session is not properly initialized.");
}
...
try {
    if ($_SESSION['is_admin'] == 'true') {
        $sql = "SELECT car.car_name, users.email, bookings.id, bookings.nr_days, bookings.date, bookings.is_approved, bookings.time 
                FROM car
                INNER JOIN bookings ON car.id = bookings.car_id 
            ...
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    <?php if ($_SESSION['is_admin'] == 'true') { ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="list_car.php">
                                <span data-feather="file"></span>
                                car
                            </a>
                        </li>
                ...
                <table class="table table-striped table-sm">
                    ...
                    <?php if ($_SESSION['is_admin'] == 'true') { ?>
                        <?php foreach ($bookings_data as $booking_data) { ?>
                            ...
                            <tr>
                                <td><?php echo $booking_data['car_name']; ?></td>
                                <td><?php echo $booking_data['email']; ?></td>
                                <td><?php echo $booking_data['nr_days']; ?></td>
