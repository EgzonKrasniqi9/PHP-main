  ...
  <div class="row">
        ...
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" href="dashboard.php">
              ...
              productDashboard <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">productsDashboard</h1>
      </div>  
        ...
        <table>
          ...
          <tbody>
            <tr> 
              ...
              <td> <?= $user['quantity']  ?> </td> 
              <td> <?= $user['price']  ?> </td>
              <td> <?= "<a href='deleteProduct.php?id=$products[id]'> Delete</a>| <a href='product.php?id=$products[id]'> Update </a>"?></td>
            </tr>
